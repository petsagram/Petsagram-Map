...
//        pointAnnotation.title = place.placemark.name ?? "No Name"
        ...
        let pointAnnotation = ImageAnnotation(title: place.placemark.name ?? "No Name",
                                              subtitle: place.placemark.areasOfInterest?.first ?? "",
                                              coordinate: coordinate)
        pointAnnotation.image = UIImage(named: "location")!
